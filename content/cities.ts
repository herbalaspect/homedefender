...
export const cities: CityPage[] = [
  ...
  },
  {
    ...
    metaDescription: "Trusted roof replacement for Cottage Grove homes. Local Madison-area contractor with 10-year workmanship warranty, written estimates, and insurance claim help.",
  ...
  },
  {
    ...
    metaDescription: "Quality roof replacement for McFarland homeowners. Lake-area expertise, 10-year workmanship warranty, transparent pricing, and free written estimates.",
  ...
  },
  {
    ...
    metaDescription: "Reliable roof replacement for Oregon, WI homeowners. 10-year workmanship warranty, quality materials, transparent pricing, and insurance claim help.",
  ...
  },
  {
    ...
    metaDescription: "Quality roof replacement for Monona homeowners. Lake-area expertise, 10-year workmanship warranty, transparent pricing, and free written estimates.",
...
Where Shorewood Hills differs in practice: the village has stronger expectations for project visibility and neighbor communication during the work itself. We coordinate dumpster placement, debris management, and crew presence in ways that respect the residential character of the streets. This isn't a regulatory requirement — it's a courtesy expectation that distinguishes contractors who work the area regularly from those who don't.`,
  ...
  },
  {
    ...
    isNeighborhood: true,
    parentCity: "Madison",
    title: "Roof Replacement in Spring Harbor, Madison | Home Defender Remodeling",
...
For lakefront properties specifically, there can be additional shoreland zoning considerations if the project involves anything beyond standard roof replacement (e.g. dormer additions, structural changes, work near the shoreline setback). We flag these during the inspection and walk you through any additional approvals needed.`,
  ...
  },
  {
    ...
    isNeighborhood: true,
    parentCity: "Madison",
    title: "Roof Replacement in University Heights, Madison | Home Defender Remodeling",
    metaDescription: "Roofing contractor for University Heights historic district homes. Landmarks Commission approval, period-appropriate materials, premium installations.",
...
For Prairie School homes specifically, the deep eave and low-pitch design means the roofing material itself is less visible from the street than on Period Revival homes — which gives more flexibility on the visible-from-public-way standard.`,
  ...
  },
  {
    ...
    isNeighborhood: true,
    parentCity: "Madison",
    title: "Roof Replacement in Marquette, Madison | Home Defender Remodeling",
...
What all Marquette homes share: lake-adjacent exposure (Lake Monona is closer to most homes here than Lake Mendota is to University Heights), historic district oversight, and a neighborhood culture that values genuine local craftsmanship over generic contractor work.`,
  ...
  },
  {
    ...
    isNeighborhood: true,
    parentCity: "Madison",
    title: "Roof Replacement in Nakoma, Madison | Home Defender Remodeling",
    metaDescription: "Roofing contractor for Nakoma neighborhood homes in Madison. Period Revival expertise, premium materials, 10-year warranty, free in-home consultation.",
